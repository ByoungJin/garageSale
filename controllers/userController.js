 ...
 */
exports.loginPost = co.wrap(function*(req, res, next) {
    ...
    var user = yield User.getUser(req.body.email);
 ...
 * POST /signup
 */
exports.signupPost = co.wrap(function*(req, res, next) {
 ...
 */
exports.accountPut = co.wrap(function*(req, res, next) {
    ...
    var user = yield User.getUser(req.user.id);
 ...
 * GET /unlink/:provider
 */
exports.unlink = co.wrap(function*(req, res, next) {
    var user = User.getUser(req.user.id);
